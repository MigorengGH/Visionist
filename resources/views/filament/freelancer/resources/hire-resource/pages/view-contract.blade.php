            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                    ...
                    <div class="mb-2">
                        ...
                        <div class="text-base font-medium text-gray-900 dark:text-white">{{ $client->name }}</div>
                    </div>
                    <div>
                        <div class="text-xs text-gray-500 dark:text-gray-400">Email</div>
                        <div class="text-base font-medium text-gray-900 dark:text-white">{{ $client->email }}</div>
                    </div>
                </div>
                <div class="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
        ...
        <div class="bg-white dark:bg-gray-900 rounded-xl shadow p-6 mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-4">
                <div>
                    ...
                    <div class="text-base font-medium text-gray-900 dark:text-white">{{ $hire->title ?? 'N/A' }}</div>
                </div>
                <div>
                    ...
                    <div class="text-base font-medium text-gray-900 dark:text-white">
                        @if($hire->is_online)
                            Online Job
                        @else
                            {{ optional($hire->district)->name }}, {{ optional($hire->state)->name }}
                        @endif
                    </div>
                </div>
                <div>
                    ...
                    <div class="text-base font-medium text-gray-900 dark:text-white">
                        MYR {{ number_format($hire->price, 2) }}
                    </div>
                </div>
            </div>
            <div class="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                ...
                <div class="text-base font-medium text-gray-900 dark:text-white prose max-w-none dark:prose-invert">
                    {!! $hire->description ?? 'No description available' !!}
                </div>
            </div>
        </div>
